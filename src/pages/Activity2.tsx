            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-amber-600 text-white rounded-lg transition-all duration-300"
                >
                  <ArrowLeft className="w-4 h-4" />
                  <span>Previous</span>
                </button>
                <span className="text-slate-400">Activity 2 of 3</span>
                <button
                  onClick={() => onNavigate('activity3')}
                  className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-amber-600 text-white rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/30"
                >
                  <span>Next</span>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in-down">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/20 rounded-full mb-6">
                ...
                <span className="text-amber-400 font-semibold">Activity 2</span>
              </div>
              <h1 className="text-5xl font-bold text-white mb-4">Hybrid Solar + Wind System</h1>
              <p className="text-2xl text-amber-400 mb-6">Rural Health Clinic</p>
            ...
            <div className="grid lg:grid-cols-2 xl:grid-cols-4 gap-6 mb-16">
              {features.map((feature, index) => (
                ...
                >
                  <div className="relative h-full bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 p-6 hover:border-amber-500/50 transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-amber-500/20">
                    <div className="absolute inset-0 bg-gradient-to-br from-amber-500 to-orange-600 opacity-0 group-hover:opacity-10 transition-opacity duration-500 rounded-2xl" />
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-3xl border border-slate-700/50 p-12 mb-16 animate-fade-in-up delay-300">
              ...
              <div className="space-y-10">
                <div className="group">
                  <h3 className="text-2xl font-semibold text-amber-400 mb-4 group-hover:translate-x-2 transition-transform duration-300">
                    Source of Energy
                  </h3>
                  <div className="text-slate-300 text-lg leading-relaxed space-y-3">
                    <p>
                      <strong className="text-white">Solar PV:</strong> Photovoltaic panels convert sunlight directly
                    ...
                    <p>
                      <strong className="text-white">Wind Turbine:</strong> A small-scale wind turbine (typically 5-10 kW
                ...
                <div className="group">
                  ...
                  <div className="text-slate-300 text-lg leading-relaxed space-y-3">
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li><strong className="text-white">Critical loads:</strong> Medical equipment, vaccine refrigeration, emergency lighting, and communication systems receive priority power</li>
                      <li><strong className="text-white">Non-critical loads:</strong> General lighting, HVAC, and office equipment can be shed during low-battery conditions</li>
                      <li><strong className="text-white">Backup integration:</strong> ATS automatically connects grid or diesel generator when renewable sources cannot meet demand</li>
                    </ul>
                    <p>
            ...
            <div className="bg-gradient-to-br from-amber-900/30 to-orange-900/30 backdrop-blur-sm rounded-3xl border border-amber-700/50 p-12 animate-fade-in-up delay-400">
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {specs.map((spec, index) => (
                  <div
                    key={index}
                    className="bg-slate-800/50 rounded-xl p-6 border border-slate-700/50 hover:border-amber-500/50 transition-all duration-300 hover:scale-105"
                  >
            ...
            <div className="flex items-center justify-between mt-16 pt-8 border-t border-slate-700/50">
              ...
              <button
                onClick={() => onNavigate('activity3')}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/30"
              >
